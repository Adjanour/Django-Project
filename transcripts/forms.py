...
class TranscriptRequestForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "delivery_email": forms.EmailInput(
                attrs={
            ...
            "number_of_transcripts": forms.NumberInput(
                attrs={
                    "class": "w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500",
                    "placeholder": "Number of Transcripts",
                    "required": "True",
                }
            ),
            "transcript_type": forms.Select(
                attrs={
                    "class": "w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500",
                    "placeholder": "Transcript Type",
